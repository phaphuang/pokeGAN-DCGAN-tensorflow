### inspire by https://www.youtube.com/watch?v=yz6dNf7X7SA&t=311s
...
def process_data():
    ...
    image_queue = tf.train.slice_input_producer([all_images])

    content = tf.read_file(image_queue[0])
    ...
    # noise = tf.Variable(tf.truncated_normal(shape = [HEIGHT, WIDTH, CHANNEL], dtype=tf.float32))
...
def train():
    ...
    with tf.variable_scope('input'):
        ...
        random_input = tf.placeholder(dtype=tf.float32, shape=[None, random_dim], name='rand_input')
